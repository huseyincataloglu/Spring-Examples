...
public class PaymentController {
    ...
    public ResponseEntity<?> makePayment(){
        String paymentReturn = paymentService.performPayment(new PaymentDetails());
    ...
    public ResponseEntity<PaymentDetails> postPayment(@RequestBody PaymentDetails paymentDetail){
    ...
    }// we have returnd object as json format
